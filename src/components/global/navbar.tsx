...
const Navbar=async() => {
    return <header className="fixed right-0 left-0 top-0 py-4 px-4 bg-black/40 backdrop-blur-lg z-100 flex items-center border-b border-neutral-900 justify-between">
        <aside className="flex item-center gap-0.5 ">
